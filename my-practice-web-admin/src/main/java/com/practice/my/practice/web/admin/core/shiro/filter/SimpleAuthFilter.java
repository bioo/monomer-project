package com.practice.my.practice.web.admin.core.shiro.filter;
...
import com.practice.my.practice.web.admin.core.shiro.session.SessionStatus;
import com.practice.my.practice.web.admin.core.shiro.util.ShiroFilterUtils;
...
public class SimpleAuthFilter extends AccessControlFilter {
	...
	private void out(ServletResponse hresponse, Map<String, String> resultMap)
		...
		out.println(JSONObject.parseObject(JSON.toJSONString(resultMap)).toString());
		out.flush();
		out.close();
	}
}
